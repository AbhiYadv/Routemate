...
const TRUST_PILLARS = [
  ...
  { icon: 'map-outline' as const, color: '#2563EB', text: 'See live routes before booking' },
...
export default function LandingPage() {
  ...
  return (
    <SafeAreaView style={tw`flex-1 bg-[#F0F7FF] pt-${Platform.OS === 'android' ? '8' : '0'}`}>
      <View style={tw`flex-1 justify-between px-8 py-10`}>
        ...
        <View style={tw`items-center mt-6`}>
          ...
          <Text style={tw`text-lg font-semibold text-[#2563EB] mb-8 text-center`}>
