  ...
  return (
    <SafeAreaView style={tw`flex-1 bg-[#F8FAFC] pt-${Platform.OS === 'android' ? '8' : '0'}`}>
      ...
      <ScrollView contentContainerStyle={tw`p-6 pb-32`}>
        ...
        <TouchableOpacity style={tw`bg-blue-50 border-2 border-[#2563EB] rounded-xl p-4 mb-3 flex-row items-center shadow-sm`}>
          <Ionicons name="radio-button-on" size={24} color="#2563EB" style={tw`mr-3`} />
          <View style={tw`flex-1`}>
            <Text style={tw`text-[#0F172A] font-extrabold text-base mb-0.5`}>Company Circle</Text>
            <Text style={tw`text-blue-800 text-xs font-medium`}>Only verified coworkers from your company can view and join.</Text>
          </View>
